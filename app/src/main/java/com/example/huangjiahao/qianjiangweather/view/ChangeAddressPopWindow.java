...
import com.example.huangjiahao.qianjiangweather.adapter.wheelviewadapter.AbstractWheelTextAdapter1;
import com.example.huangjiahao.qianjiangweather.view.wheelview.OnWheelChangedListener;
import com.example.huangjiahao.qianjiangweather.view.wheelview.OnWheelScrollListener;
import com.example.huangjiahao.qianjiangweather.view.wheelview.WheelView;
...
/**
 * Created by JiaHao.H on 2017/4/25.
 */
...
public class ChangeAddressPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    public ChangeAddressPopWindow(final Context context) {
        ...
        View view=View.inflate(context,R.layout.layout_edit_changeaddress_pop,null);
        ...
        lyChangeAddress = view.findViewById(R.id.ll_myinfo_changeaddress);
        lyChangeAddressChild = view.findViewById(R.id.ll_myinfo_changeaddress_child);
        btnSure = (TextView) view.findViewById(R.id.tv_myinfo_sure);
        btnCancel = (TextView)view. findViewById(R.id.tv_myinfo_cancel);
...
//		this.setAnimationStyle(R.style.AnimBottom);
    ...
    private class AddressTextAdapter extends AbstractWheelTextAdapter1 {
        ...
        protected AddressTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
            super(context, R.layout.item_address_select, NO_RESOURCE, currentItem, maxsize, minsize);
            this.list = list;
